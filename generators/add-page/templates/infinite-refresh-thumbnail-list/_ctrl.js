...
angular.module('<%= appName %>.controllers')
  ...
  .controller('<%= firstCapCamelCtrlName %>Ctrl', ['$scope', '$rootScope', '$state', '$ionicScrollDelegate', 'ionicModal', 'appConstants', 'restService',

    function($scope, $rootScope, $state, $ionicScrollDelegate, ionicModal, appConstants, restService) {
