...
function mergeJSONFile(templatePath, destinationPath, data) {
  var templateFileJSON = require(templatePath);
  var destinationFileJSON = require(destinationPath);
  var newFileJSON = _.merge(destinationFileJSON, templateFileJSON);
  fs.writeFileSync(destinationPath, _.template(JSON.stringify(newFileJSON, null, 2))(data), 'utf8');
}
